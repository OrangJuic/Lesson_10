...
<body>
  <section id="header">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #C7000A;">
      <!-- class: rounded-circle 圖片大小自動調整 -->
          ...
          <div class="row text-center">
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">游離型軟膠囊，採用金盞花植物萃取含20﹪葉黃素，調節生理機能，營養補給，健康維持。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">手術後保養，約會前急救聖品，媲美專櫃等級！網友推薦最新使用，肌膚很水嫩，感覺很透亮。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">無論混合肌、油性肌、痘痘肌、乾性肌、過敏肌等《任何膚質適用》，是修護型保養品！！
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">迷迭香精油+薰衣草精油(大自然植物舒眠系列)！！
                </p>
          ...
          <div class="row text-center">
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">金貝貝棉柔魔術氈XXL27+1片【6包/箱】，適用15公斤以上
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">【IH】櫻桃肌粉餅撲角型-3入 CB-3204，乾濕兩用的粉餅專用粉撲。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">NOYL化妝刷套裝組(附收納袋) NY-369，保存期限：7年
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">【Keep in touch】3D蘋果光氣墊粉餅，15g+15g(買一送一補充蕊)。
                </p>
          ...
          <div class="row text-center">
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">魔術性感美唇膏，不沾杯超持久唇色，想不到的魔術效果持續久久。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">DMC 欣蘭 水透透三合一凝凍 洗卸/面膜/精華霜 150g。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">日本森下仁丹整晚貼眼膜 5對/盒，長效整晚貼，慢速釋放保濕因子。
                </p>
            ...
            <div class="card col-md-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">【美爽爽】泡泡染BUBBLE COLOR系列，任意顏色，買五送二。
                </p>
